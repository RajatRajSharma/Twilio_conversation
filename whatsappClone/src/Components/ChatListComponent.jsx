...
const MemoizedChatList = React.memo(
  ({ filteredUsers, loadChat, unreadCount, activeService }) => (
    <ChatList>
...
const ChatListComponent = () => {
  const { listofUsers, loadChat, searchTerm, unreadCount, activeService } =
    useChatContext();
  const sortedUsers = useMemo(
    () => sortUsersWithUnread([...listofUsers], unreadCount),
